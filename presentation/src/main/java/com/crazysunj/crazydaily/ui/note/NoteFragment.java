...
public class NoteFragment extends BaseFragment<NotePresenter> implements NoteContract.View {
    ...
    protected void initView() {
        ...
        mNoteList.setLayoutManager(new LinearLayoutManager(mActivity));
    ...
    protected void initListener() {
        ...
        mAdapter.setOnMenuClickListener(item -> {
            ...
            mNoteEditDialog.setOnItemClickListener(new NoteEditDialog.OnItemClickListener() {
                @Override
                public void onEdit() {
                    NoteEditActivity.start(NoteFragment.this, item);
            ...
            mNoteEditDialog.show(mActivity);
        });
    }
