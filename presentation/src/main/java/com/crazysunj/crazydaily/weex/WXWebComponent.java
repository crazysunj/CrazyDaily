...
public class WXWebComponent extends WXComponent {
    ...
    @Deprecated
    public WXWebComponent(WXSDKInstance instance, WXVContainer parent, String instanceId, boolean isLazy, BasicComponentData basicComponentData) {
        this(instance, parent, isLazy, basicComponentData);
    }

    public WXWebComponent(WXSDKInstance instance, WXVContainer parent, boolean isLazy, BasicComponentData basicComponentData) {
    ...
    protected View initComponentHostView(@NonNull Context context) {
        ...
        mWebView.setOnMessageListener(params -> fireEvent(Constants.Event.ONMESSAGE, params));
